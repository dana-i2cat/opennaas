...
<div id="createVCPENetwork">
	<form:form modelAttribute="VCPENetwork" action="${action}"
		method="post">
		<form:hidden path="id" />
		...
		<div id="vcpe">
			<h2>
				<spring:message code="vcpenetwork.create.vcpe" />
				${VCPENetwork.name}
			</h2>
			<div id="acc_body">
				<!-- BGP -->
				<div id="bgp">
					...
					<div>
						...
						<button id="button2" class="button" disabled="disabled">
							...
							<div class="input">
								<c:choose>
									<c:when test="${item.labelName == 'Up'}">
										...
										<form:errors
											path="logicalRouter1.interfaces[${vs.index}].name" size="8" />
										<form:input path="logicalRouter1.interfaces[${vs.index}].port"
											size="3"
										...
										<form:input
											...
											size="13"
											onchange="isIPFree('${VCPENetwork.id}', this.value);" />
										<form:errors
											path="logicalRouter1.interfaces[${vs.index}].ipAddress"
											size="13" />
										<br>
										...
										<form:input path="logicalRouter1.interfaces[${vs.index}].vlan"
											size="3"
											onchange="isVLANFree('${VCPENetwork.id}', this.value);" />
										<form:errors
											path="logicalRouter1.interfaces[${vs.index}].vlan" size="3" />
									</c:when>
								</c:choose>
							</div>
						</c:forEach>
							...
							<div class="input">
								<c:choose>
									<c:when test="${item.labelName == 'Up'}">
										...
										<form:errors
											path="logicalRouter2.interfaces[${vs.index}].name" size="8" />
										<form:input path="logicalRouter2.interfaces[${vs.index}].port"
											size="3"
										...
										<form:input path="logicalRouter2.interfaces[${vs.index}].vlan"
											...
											onchange="isVLANFree('${VCPENetwork.id}', this.value);" />
										<form:errors
											path="logicalRouter2.interfaces[${vs.index}].vlan" size="3" />
									</c:when>
								</c:choose>
							</div>
						</c:forEach>
					...
					<div id="lr_master">
						...
						<div>
							...
							<button id="button5" class="button">
								<spring:message code="buttons.activate" />
							</button>
						</div>
					</div>
					<div id="lr_backup">
						...
						<div>
							...
							<button id="button6" class="button">
								<spring:message code="buttons.backup" />
							</button>
						</div>
					</div>
					<!-- VCPE Interfaces -->
		...
		<div id="bod">
			<h2>
				<spring:message code="bod" />
			</h2>
			<div>
				<div id="bod_master">
					<h3>
						<spring:message code="vcpenetwork.bod.master" />
					</h3>
					<div>
						<div id="config" class="ui-widget-content">
							<p>Global configuration parameters</p>
						...
						<button id="button8" class="button">
							<spring:message code="buttons.renew" />
						</button>
					</div>
				</div>
				<div id="bod_inter">
				...
				<div id="bod_backup">
					...
					<div>
						...
						<button id="button23" class="button">
							<spring:message code="buttons.renew" />
						</button>
					</div>
				</div>
		...
		<div id="client_interfaces">
			<div id="client_down_master" class="ui-widget-content">
				<div class="input">
					...
					<spring:message code="interface.name" />
					<form:input path="bod.ifaceClient.name" size="8"
						onchange="isInterfaceFree('${VCPENetwork.id}', this.value, document.getElementById('bod.ifaceClient.port').value);" />
					.
					<form:errors path="bod.ifaceClient.name" size="8" />
					<form:input path="bod.ifaceClient.port" size="3"
						onchange="isInterfaceFree('${VCPENetwork.id}', document.getElementById('bod.ifaceClient.name').value, this.value);" />
					<form:errors path="bod.ifaceClient.port" size="3" />
					<br>
					<spring:message code="interface.vlan" />
					<form:input path="bod.ifaceClient.vlan" size="3"
						onchange="isVLANFree('${VCPENetwork.id}', this.value);" />
			...
			<div id="client_down_backup" class="ui-widget-content">
				<div class="input">
					...
					<spring:message code="interface.name" />
					<form:input path="bod.ifaceClientBackup.name" size="8"
						onchange="isInterfaceFree('${VCPENetwork.id}', this.value, document.getElementById('bod.ifaceClientBackup.port').value);" />
					.
					<form:errors path="bod.ifaceClientBackup.name" size="8" />
					<form:input path="bod.ifaceClientBackup.port" size="3"
						onchange="isInterfaceFree('${VCPENetwork.id}', document.getElementById('bod.ifaceClientBackup.name').value, this.value);" />
					<form:errors path="bod.ifaceClientBackup.port" size="3" />
					<br>
					<spring:message code="interface.vlan" />
					<form:input path="bod.ifaceClientBackup.vlan" size="3"
						onchange="isVLANFree('${VCPENetwork.id}', this.value);" />
		...
		<div id="client">
			...
			<div id="client_data" class="ui-widget-content">
				...
				<input id="submitButton" class="button" onclick="" type="submit"
					value="<spring:message code="buttons.create"/>" />
			</div>
		</div>
		<!-- End client -->
