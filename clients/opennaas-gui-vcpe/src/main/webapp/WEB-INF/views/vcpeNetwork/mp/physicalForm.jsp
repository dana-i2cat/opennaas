				...
				<div id="iface_router_up1" class="ui-widget-content">	
					...
					<div class="ui-widget-content config_content">								
						<div>
							...
							<form:label path="">ge-2/0/0</form:label>	
						</div>		
					</div>										
				</div>
				...
				<div id="phy_router">
					...
					<div>			
						<div id="config" class="ui-widget-content">
							...
							<form:label path="" >Physical interface name: ge-2/0/0</form:label>
						</div>		
						<div id="config" class="ui-widget-content">
							<b><spring:message code="mp.physical.logicaltunnel"/></b><br>
							<form:label path="" >Logical Tunel interface name: ge-2/0/0</form:label>
						</div>		
					</div>
				</div>
