...
<script>
    //var tabContent = '<iframe src="//mininetIP/webconsole/webconsole.php" id="gadget{id}" name="gadget{id}" frameborder="1" width="100%" height="500"></iframe>',
    var tabContent = '<iframe src="//'+mininetIP+'/{hostName}" id="gadget{id}" name="gadget{id}" frameborder="1" width="100%" height="500"></iframe>',
