...
public class QueueManagerTest {
	...
	private static void listIds() {
		String url = "http://localhost:8888/opennaas/router/junos20/queue/listIds";
	...
	private static void list() {
		String url = "http://localhost:8888/opennaas/router/junos20/queue/list";
	...
	private static void modify() {
		String url = "http://localhost:8888/opennaas/router/junos20/queue/modify";
	...
	private static void clear() {
		String url = "http://localhost:8888/opennaas/router/junos20/queue/clear";
	...
	private static void execute() {
		...
		String url = "http://localhost:8888/opennaas/router/junos20/queue/execute";
