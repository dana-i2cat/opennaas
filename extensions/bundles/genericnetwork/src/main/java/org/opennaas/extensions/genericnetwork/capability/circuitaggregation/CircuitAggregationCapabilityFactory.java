 ...
 * 
 */
public class CircuitAggregationCapabilityFactory extends AbstractCapabilityFactory {

	@Override
	public ICapability create(IResource resource) throws CapabilityException {
		ICapability capability = this.create(resource.getResourceDescriptor().getCapabilityDescriptor(CircuitAggregationCapability.CAPABILITY_TYPE),
	...
	public ICapability createCapability(CapabilityDescriptor capabilityDescriptor, String resourceId) throws CapabilityException {
		return new CircuitAggregationCapability(capabilityDescriptor, resourceId);
	}
