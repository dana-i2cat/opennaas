...
public class OSPFCapabilityServiceImpl extends GenericCapabilityServiceImpl implements IOSPFCapabilityService {
	...
	public void activateOSPF(String resourceId) throws CapabilityException {
		try {
			IOSPFCapability iOSPFCapability = (IOSPFCapability) getCapability(resourceId, OSPFCapability.CAPABILITY_TYPE);
