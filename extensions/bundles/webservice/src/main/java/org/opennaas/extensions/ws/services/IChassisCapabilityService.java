...
public interface IChassisCapabilityService {
	 ...
	 * 
	 * @param iface
	 *            to activate (must be a physical one) @ * if any error occurred. In that case, queue remains untouched.
	 */
	 ...
	 * 
	 * @param iface
	 *            to deactivate (must be a physical one) @ * if any error occurred. In that case, queue remains untouched.
	 */
	 ...
	 *            to use in given iface @ * if any error occurred. In that case, queue remains untouched.
	 */
	 ...
	 * @param interfaces
	 *            to be added to the logical router @ * if any error occurred. In that case, queue remains untouched.
	 */
	 ...
	 * @param interfaces
	 *            to be removed from the logical router @ * if any error occurred. In that case, queue remains untouched.
	 */
