 ...
 *
 */
public class RyuResourceRepository extends ResourceRepository {

	/**
	 * Logger
	 */
	Log	log	= LogFactory.getLog(RyuResourceRepository.class);

	/**
	 * @param resourceType
	 */
	public RyuResourceRepository(String resourceType) {
