 ...
 *
 */
public class MonitoringModuleCapabilityFactory extends AbstractCapabilityFactory {
	...
	public ICapability create(IResource resource) throws CapabilityException {
		...
		ICapability capability = this.create(resource.getResourceDescriptor().getCapabilityDescriptor(MonitoringModuleCapability.CAPABILITY_TYPE),
	...
	public ICapability createCapability(CapabilityDescriptor capabilityDescriptor, String resourceId) throws CapabilityException {
		...
		return new MonitoringModuleCapability(capabilityDescriptor, resourceId);
	}
