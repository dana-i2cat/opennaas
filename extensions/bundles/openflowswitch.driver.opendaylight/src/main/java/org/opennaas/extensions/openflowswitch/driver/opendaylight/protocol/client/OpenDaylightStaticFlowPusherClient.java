...
/**
 * OpenDaylight special client mixing CXF and Java clients allowing sending HTTP DELETE with body
 * 
 * @author logoff
 * 
 */
...
//            messageBody = "{\"installInHw\":\"true\", \"name\":\""+name+"\", \"node\": {\"id\":\""+DPID+"\", \"type\":\"OF\"}, \"ingressPort\":\"2\", \"etherType\": $
