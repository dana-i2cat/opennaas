...
public class OpenDaylightProtocolSession implements IProtocolSession {
	...
	private IOpenDaylightStaticFlowPusherClient		opendaylightStaticFlowPusherClient;

	public OpenDaylightProtocolSession(String sessionID,
	...
	/**
	 * This method should NOT be used in Actions to retrieve the client. In Actions use getOpenDaylightClientForUse instead.
	 * 
	 * @return opendaylightStaticFlowPusherClient
	 * @see getOpenDaylightClientForUse()
	 */
	public IOpenDaylightStaticFlowPusherClient getOpenDaylightClient() {
		return opendaylightStaticFlowPusherClient;
	}

	public void setOpenDaylightClient(IOpenDaylightStaticFlowPusherClient opendaylightStaticFlowPusherClient) {
	 ...
	 */
	public IOpenDaylightStaticFlowPusherClient getOpenDaylightClientForUse() throws ProtocolException {
		if (!status.equals(Status.CONNECTED)) {
			throw new ProtocolException(
