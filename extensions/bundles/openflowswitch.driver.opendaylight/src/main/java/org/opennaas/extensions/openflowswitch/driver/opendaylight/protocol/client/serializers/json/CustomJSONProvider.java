...
public class CustomJSONProvider extends JacksonJsonProvider {
	...
	public CustomJSONProvider() {
		...
		SimpleModule myModule = new SimpleModule("MypenDaylightOFFlowJSONSerializerDeserializerModule", new Version(1, 0, 0, null));
		myModule.addSerializer(new OpenDaylightOFFlowJSONSerializer()); // assuming FloodlightOFFlowJSONSerializer declares correct class to bind to
