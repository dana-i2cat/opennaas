...
/**
 * This class is the java representation of an Acknoledgement message. The ACK Codes are located in the ACKCode Interface.
 * 
...
public class TL1AckMsg extends TL1OutputMsg
{
	...
	/**
	 * Verify that the Ack code for this ACK message is valid. If the transport received a non standard message such as a welcome message where the is
	 * no message code, it will get caught in this method and thrown out by the calling method.
	 * 
