package net.i2cat.luminis.commandsets.wonesys.commands.pstn25g;

import net.i2cat.luminis.commandsets.wonesys.WonesysCommand;
import org.opennaas.core.resources.command.CommandException;

public class GetDWDMChannelPlan extends WonesysCommand {

	private static final String	COMMAND_ID	= "0207";
