...
public class CustomJSONProvider extends JacksonJsonProvider {
	...
	public CustomJSONProvider() {
		...
		SimpleModule myModule = new SimpleModule("MyCountersMapJSONDeserializerModule", new Version(1, 0, 0, null));
		myModule.addDeserializer(CountersMap.class, new CountersMapJSONDeserializer());
