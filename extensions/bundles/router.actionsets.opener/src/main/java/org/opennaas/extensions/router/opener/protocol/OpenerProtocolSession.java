...
public class OpenerProtocolSession implements IProtocolSession {
	 ...
	 * In Actions use getOpenerClientForUse instead.
	 * @return openerClient
	...
	/**
	 * Retrieve openerClient and checks session is connected.
	 * This method may be used in Actions to retrieve the OpenerClient and call its methods afterwards.
	 *  
