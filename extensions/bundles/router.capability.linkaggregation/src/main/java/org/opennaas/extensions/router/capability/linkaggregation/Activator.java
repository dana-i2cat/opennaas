...
public class Activator extends AbstractActivator implements BundleActivator {
	...
	public static IActionSet getLinkAggregationActionSetService(String name, String version) throws ActivatorException {
		try {
			log.debug("Calling LinkAggregationActionSetService");
			return (IActionSet) getServiceFromRegistry(context, createFilterLinkAggregationActionSet(name, version));
		} catch (InvalidSyntaxException e) {
			throw new ActivatorException(e);
		}
	}
	 ...
	 * necessary to get some capability type
	 */
	private static Filter createFilterLinkAggregationActionSet(String name, String version) throws InvalidSyntaxException {
		Properties properties = new Properties();
		properties.setProperty(ResourceDescriptorConstants.ACTION_CAPABILITY, LinkAggregationCapability.CAPABILITY_TYPE);
