...
import org.opennaas.extensions.opendaylight.vtn.actionssets.OpenDaylightConstants;
...
public class OpenDaylightActionsTest {
    ...
    private CreateVTNAction createOFForwardingAction;

    @Before
    public void initActions() {
        createOFForwardingAction = new CreateVTNAction();
