 ...
 * 
 */
package org.opennaas.extensions.vcpe.capability.builder.builders.sp.v6;
 ...
 * @author Jordi
 */
public class VCPESingleProviderV6 implements IVCPENetworkBuilder {

	private Log	log	= LogFactory.getLog(VCPESingleProviderV6.class);
