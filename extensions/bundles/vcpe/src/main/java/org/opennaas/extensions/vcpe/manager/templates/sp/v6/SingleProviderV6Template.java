 ...
 * 
 */
package org.opennaas.extensions.vcpe.manager.templates.sp.v6;
...
public class SingleProviderV6Template implements ITemplate {
	 ...
	 * 
	 */
	public SingleProviderV6Template() throws VCPENetworkManagerException {
		try {
			suggestor = new SPV6TemplateSuggestor();
	...
	private VCPENetworkModel generatePhysicalElements() {
		...
		core.setTemplateName(SPV6TemplateConstants.CORE_PHY_ROUTER);

		Interface coreMaster = new Interface();
		coreMaster.setTemplateName(SPV6TemplateConstants.CORE_PHY_INTERFACE_MASTER);

		Interface coreBkp = new Interface();
		coreBkp.setTemplateName(SPV6TemplateConstants.CORE_PHY_INTERFACE_BKP);

		Interface coreLo = new Interface();
		coreLo.setTemplateName(SPV6TemplateConstants.CORE_PHY_LO_INTERFACE);
		...
		r1.setTemplateName(SPV6TemplateConstants.CPE1_PHY_ROUTER);

		Interface inter1 = new Interface();
		inter1.setTemplateName(SPV6TemplateConstants.INTER1_PHY_INTERFACE_LOCAL);

		Interface inter1other = new Interface();
		inter1other.setTemplateName(SPV6TemplateConstants.INTER1_PHY_INTERFACE_AUTOBAHN);

		Interface down1 = new Interface();
		down1.setTemplateName(SPV6TemplateConstants.DOWN1_PHY_INTERFACE_LOCAL);

		Interface down1other = new Interface();
		down1other.setTemplateName(SPV6TemplateConstants.DOWN1_PHY_INTERFACE_AUTOBAHN);

		Interface up1 = new Interface();
		up1.setTemplateName(SPV6TemplateConstants.UP1_PHY_INTERFACE_LOCAL);

		Interface client1 = new Interface();
		client1.setTemplateName(SPV6TemplateConstants.CLIENT1_PHY_INTERFACE_AUTOBAHN);

		Interface lo1 = new Interface();
		lo1.setTemplateName(SPV6TemplateConstants.LO1_PHY_INTERFACE);
		...
		r2.setTemplateName(SPV6TemplateConstants.CPE2_PHY_ROUTER);

		Interface inter2 = new Interface();
		inter2.setTemplateName(SPV6TemplateConstants.INTER2_PHY_INTERFACE_LOCAL);

		Interface inter2other = new Interface();
		inter2other.setTemplateName(SPV6TemplateConstants.INTER2_PHY_INTERFACE_AUTOBAHN);

		Interface down2 = new Interface();
		down2.setTemplateName(SPV6TemplateConstants.DOWN2_PHY_INTERFACE_LOCAL);

		Interface down2other = new Interface();
		down2other.setTemplateName(SPV6TemplateConstants.DOWN2_PHY_INTERFACE_AUTOBAHN);

		Interface up2 = new Interface();
		up2.setTemplateName(SPV6TemplateConstants.UP2_PHY_INTERFACE_LOCAL);

		Interface client2 = new Interface();
		client2.setTemplateName(SPV6TemplateConstants.CLIENT2_PHY_INTERFACE_AUTOBAHN);

		Interface lo2 = new Interface();
		lo2.setTemplateName(SPV6TemplateConstants.LO2_PHY_INTERFACE);
		...
		autobahn.setTemplateName(SPV6TemplateConstants.AUTOBAHN);
	...
	private VCPENetworkModel generateLogicalElements() {
		...
		vcpe1.setTemplateName(SPV6TemplateConstants.VCPE1_ROUTER);
		...
		inter1.setTemplateName(SPV6TemplateConstants.INTER1_INTERFACE_LOCAL);
		down1.setTemplateName(SPV6TemplateConstants.DOWN1_INTERFACE_LOCAL);
		up1.setTemplateName(SPV6TemplateConstants.UP1_INTERFACE_LOCAL);
		lo1.setTemplateName(SPV6TemplateConstants.LO1_INTERFACE);

		// LogicalRouter 2
		Router vcpe2 = new LogicalRouter();
		vcpe2.setTemplateName(SPV6TemplateConstants.VCPE2_ROUTER);
		...
		inter2.setTemplateName(SPV6TemplateConstants.INTER2_INTERFACE_LOCAL);
		down2.setTemplateName(SPV6TemplateConstants.DOWN2_INTERFACE_LOCAL);
		up2.setTemplateName(SPV6TemplateConstants.UP2_INTERFACE_LOCAL);
		lo2.setTemplateName(SPV6TemplateConstants.LO2_INTERFACE);
		...
		inter1other.setTemplateName(SPV6TemplateConstants.INTER1_INTERFACE_AUTOBAHN);
		down1other.setTemplateName(SPV6TemplateConstants.DOWN1_INTERFACE_AUTOBAHN);
		inter2other.setTemplateName(SPV6TemplateConstants.INTER2_INTERFACE_AUTOBAHN);
		down2other.setTemplateName(SPV6TemplateConstants.DOWN2_INTERFACE_AUTOBAHN);
		client1other.setTemplateName(SPV6TemplateConstants.CLIENT1_INTERFACE_AUTOBAHN);
		client2other.setTemplateName(SPV6TemplateConstants.CLIENT2_INTERFACE_AUTOBAHN);
		...
		up1other.setTemplateName(SPV6TemplateConstants.UP1_INTERFACE_PEER);
		up2other.setTemplateName(SPV6TemplateConstants.UP2_INTERFACE_PEER);
		corelo.setTemplateName(SPV6TemplateConstants.CORE_LO_INTERFACE);

		// LINKS

		// Inter links
		Link linkInter1local = VCPENetworkModelHelper.createLink(null, SPV6TemplateConstants.INTER1_LINK_LOCAL, SPV6TemplateConstants.LINK_TYPE_ETH,
				inter1, inter1other);
		Link linkInter1other = VCPENetworkModelHelper.createLink(null, SPV6TemplateConstants.INTER_LINK_AUTOBAHN,
				SPV6TemplateConstants.LINK_TYPE_AUTOBAHN, inter1other, inter2other);
		Link linkInter2local = VCPENetworkModelHelper.createLink(null, SPV6TemplateConstants.INTER2_LINK_LOCAL, SPV6TemplateConstants.LINK_TYPE_ETH,
				inter2, inter2other);
		...
		// Up links
		Link linkUp1 = VCPENetworkModelHelper.createLink(null, SPV6TemplateConstants.UP1_LINK, SPV6TemplateConstants.LINK_TYPE_LT, up1, up1other);
		Link linkUp2 = VCPENetworkModelHelper.createLink(null, SPV6TemplateConstants.UP2_LINK, SPV6TemplateConstants.LINK_TYPE_LT, up2, up2other);

		// Virtual links
		Link linkInter = VCPENetworkModelHelper.createLink(null, SPV6TemplateConstants.INTER_LINK, SPV6TemplateConstants.LINK_TYPE_VIRTUAL, inter1,
				inter2);
		...
		Link linkdown1 = VCPENetworkModelHelper.createLink(null, SPV6TemplateConstants.DOWN1_LINK, SPV6TemplateConstants.LINK_TYPE_VIRTUAL, down1,
				client1other);
		subLinks = new ArrayList<Link>();
		subLinks.add(linkDown1local);
		subLinks.add(linkDown1other);
		linkdown1.setImplementedBy(subLinks);
		Link linkdown2 = VCPENetworkModelHelper.createLink(null, SPV6TemplateConstants.DOWN2_LINK, SPV6TemplateConstants.LINK_TYPE_VIRTUAL, down2,
				client2other);
	...
	private VCPENetworkModel mapPhysicalElementsFromInputModel(VCPENetworkModel model, VCPENetworkModel inputModel) {
		...
		if (inputClient1 != null) {
			Interface client1 = (Interface) VCPENetworkModelHelper
					.getElementByTemplateName(model, SPV6TemplateConstants.CLIENT1_PHY_INTERFACE_AUTOBAHN);
		...
		if (inputClient2 != null) {
			Interface client2 = (Interface) VCPENetworkModelHelper
					.getElementByTemplateName(model, SPV6TemplateConstants.CLIENT2_PHY_INTERFACE_AUTOBAHN);
	...
	private VCPENetworkModel mapLogicalElementsFromInputModel(VCPENetworkModel model, VCPENetworkModel inputModel) {
		...
		// Core router
		Router coreinput = (Router) VCPENetworkModelHelper.getElementByTemplateName(inputModel, SPV6TemplateConstants.CORE_PHY_ROUTER);
		Router core = (Router) VCPENetworkModelHelper.getElementByTemplateName(model, SPV6TemplateConstants.CORE_PHY_ROUTER);

		Interface coremasterinput = (Interface) VCPENetworkModelHelper.getElementByTemplateName(coreinput.getInterfaces(),
				SPV6TemplateConstants.UP1_INTERFACE_PEER);
		...
		Interface corebkpinput = (Interface) VCPENetworkModelHelper.getElementByTemplateName(coreinput.getInterfaces(),
				SPV6TemplateConstants.UP2_INTERFACE_PEER);
		...
		// LR1
		Router vcpe1input = (Router) VCPENetworkModelHelper.getElementByTemplateName(inputModel, SPV6TemplateConstants.VCPE1_ROUTER);
		Router vcpe1 = (Router) VCPENetworkModelHelper.getElementByTemplateName(model, SPV6TemplateConstants.VCPE1_ROUTER);
		...
		Interface inter1input = (Interface) VCPENetworkModelHelper.getElementByTemplateName(vcpe1input.getInterfaces(),
				SPV6TemplateConstants.INTER1_INTERFACE_LOCAL);
		Interface down1input = (Interface) VCPENetworkModelHelper.getElementByTemplateName(vcpe1input.getInterfaces(),
				SPV6TemplateConstants.DOWN1_INTERFACE_LOCAL);
		Interface up1input = (Interface) VCPENetworkModelHelper
				.getElementByTemplateName(vcpe1input.getInterfaces(), SPV6TemplateConstants.UP1_INTERFACE_LOCAL);
		Interface lo1input = (Interface) VCPENetworkModelHelper
				.getElementByTemplateName(vcpe1input.getInterfaces(), SPV6TemplateConstants.LO1_INTERFACE);
		...
		Interface down1 = (Interface) VCPENetworkModelHelper.getElementByTemplateName(vcpe1.getInterfaces(),
				SPV6TemplateConstants.DOWN1_INTERFACE_LOCAL);
		Interface up1 = (Interface) VCPENetworkModelHelper.getElementByTemplateName(vcpe1.getInterfaces(), SPV6TemplateConstants.UP1_INTERFACE_LOCAL);
		Interface lo1 = (Interface) VCPENetworkModelHelper.getElementByTemplateName(vcpe1.getInterfaces(), SPV6TemplateConstants.LO1_INTERFACE);
		...
		Router vcpe2 = (Router) VCPENetworkModelHelper.getElementByTemplateName(model, SPV6TemplateConstants.VCPE2_ROUTER);
		...
		Interface inter2input = (Interface) VCPENetworkModelHelper.getElementByTemplateName(vcpe2input.getInterfaces(),
				SPV6TemplateConstants.INTER2_INTERFACE_LOCAL);
		Interface down2input = (Interface) VCPENetworkModelHelper.getElementByTemplateName(vcpe2input.getInterfaces(),
				SPV6TemplateConstants.DOWN2_INTERFACE_LOCAL);
		Interface up2input = (Interface) VCPENetworkModelHelper
				.getElementByTemplateName(vcpe2input.getInterfaces(), SPV6TemplateConstants.UP2_INTERFACE_LOCAL);
		Interface lo2input = (Interface) VCPENetworkModelHelper
				.getElementByTemplateName(vcpe2input.getInterfaces(), SPV6TemplateConstants.LO2_INTERFACE);
		...
		Interface down2 = (Interface) VCPENetworkModelHelper.getElementByTemplateName(vcpe2.getInterfaces(),
				SPV6TemplateConstants.DOWN2_INTERFACE_LOCAL);
		Interface up2 = (Interface) VCPENetworkModelHelper.getElementByTemplateName(vcpe2.getInterfaces(), SPV6TemplateConstants.UP2_INTERFACE_LOCAL);
		Interface lo2 = (Interface) VCPENetworkModelHelper.getElementByTemplateName(vcpe2.getInterfaces(), SPV6TemplateConstants.LO2_INTERFACE);
		...
		Interface client1input = (Interface) VCPENetworkModelHelper.getElementByTemplateName(inputModel,
				SPV6TemplateConstants.CLIENT1_INTERFACE_AUTOBAHN);
		Interface client2input = (Interface) VCPENetworkModelHelper.getElementByTemplateName(inputModel,
				SPV6TemplateConstants.CLIENT2_INTERFACE_AUTOBAHN);

		Interface client1 = (Interface) VCPENetworkModelHelper.getElementByTemplateName(model, SPV6TemplateConstants.CLIENT1_INTERFACE_AUTOBAHN);
	...
	private VCPENetworkModel updateInterfacesVlanFromLinks(VCPENetworkModel model) {
		...
		toUpdate.add((Interface) VCPENetworkModelHelper.getElementByTemplateName(allIfaces, SPV6TemplateConstants.INTER1_INTERFACE_AUTOBAHN));
		toUpdate.add((Interface) VCPENetworkModelHelper.getElementByTemplateName(allIfaces, SPV6TemplateConstants.INTER2_INTERFACE_AUTOBAHN));

		toUpdate.add((Interface) VCPENetworkModelHelper.getElementByTemplateName(allIfaces, SPV6TemplateConstants.DOWN1_INTERFACE_AUTOBAHN));
		toUpdate.add((Interface) VCPENetworkModelHelper.getElementByTemplateName(allIfaces, SPV6TemplateConstants.DOWN2_INTERFACE_AUTOBAHN));

		// TODO Question: should the appl be able to modify up peer vlans (they are in core router)???
		toUpdate.add((Interface) VCPENetworkModelHelper.getElementByTemplateName(allIfaces, SPV6TemplateConstants.UP1_INTERFACE_PEER));
		toUpdate.add((Interface) VCPENetworkModelHelper.getElementByTemplateName(allIfaces, SPV6TemplateConstants.UP2_INTERFACE_PEER));

		List<Link> allLinks = VCPENetworkModelHelper.getLinks(model.getElements());
		List<Link> toUpdateLinks = new ArrayList<Link>(6);
		toUpdateLinks.add((Link) VCPENetworkModelHelper.getElementByTemplateName(allLinks, SPV6TemplateConstants.INTER1_LINK_LOCAL));
		toUpdateLinks.add((Link) VCPENetworkModelHelper.getElementByTemplateName(allLinks, SPV6TemplateConstants.INTER2_LINK_LOCAL));
		toUpdateLinks.add((Link) VCPENetworkModelHelper.getElementByTemplateName(allLinks, SPV6TemplateConstants.DOWN1_LINK_LOCAL));
		toUpdateLinks.add((Link) VCPENetworkModelHelper.getElementByTemplateName(allLinks, SPV6TemplateConstants.DOWN2_LINK_LOCAL));
		// TODO Question: should the appl be able to modify up peer vlans???
		toUpdateLinks.add((Link) VCPENetworkModelHelper.getElementByTemplateName(allLinks, SPV6TemplateConstants.UP1_LINK));
		toUpdateLinks.add((Link) VCPENetworkModelHelper.getElementByTemplateName(allLinks, SPV6TemplateConstants.UP2_LINK));
	...
	private VCPENetworkModel mapLogicalAndPhysical(VCPENetworkModel physicalInfrastructure, VCPENetworkModel logicalInfrastructure) {
		...
		Router core = (Router) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure, SPV6TemplateConstants.CORE_PHY_ROUTER);
		core.getInterfaces().add(
				(Interface) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure, SPV6TemplateConstants.UP1_INTERFACE_PEER));
		core.getInterfaces().add(
				(Interface) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure, SPV6TemplateConstants.UP2_INTERFACE_PEER));
		core.getInterfaces().add(
				(Interface) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure, SPV6TemplateConstants.CORE_LO_INTERFACE));

		// put bod logical interfaces into bod
		Domain bod = (Domain) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure, SPV6TemplateConstants.AUTOBAHN);
		bod.getInterfaces().add(
				(Interface) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure, SPV6TemplateConstants.CLIENT1_INTERFACE_AUTOBAHN));
		bod.getInterfaces().add(
				(Interface) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure, SPV6TemplateConstants.CLIENT2_INTERFACE_AUTOBAHN));
		bod.getInterfaces().add(
				(Interface) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure, SPV6TemplateConstants.INTER1_INTERFACE_AUTOBAHN));
		bod.getInterfaces().add(
				(Interface) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure, SPV6TemplateConstants.DOWN1_INTERFACE_AUTOBAHN));
		bod.getInterfaces().add(
				(Interface) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure, SPV6TemplateConstants.INTER2_INTERFACE_AUTOBAHN));
		bod.getInterfaces().add(
				(Interface) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure, SPV6TemplateConstants.DOWN2_INTERFACE_AUTOBAHN));

		// Assign logical routers to physical ones
		Router phyRouter = (Router) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure, SPV6TemplateConstants.CPE1_PHY_ROUTER);
		LogicalRouter logRouter = (LogicalRouter) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure,
				SPV6TemplateConstants.VCPE1_ROUTER);
		logRouter.setPhysicalRouter(phyRouter);

		phyRouter = (Router) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure, SPV6TemplateConstants.CPE2_PHY_ROUTER);
		logRouter = (LogicalRouter) VCPENetworkModelHelper.getElementByTemplateName(logicalInfrastructure, SPV6TemplateConstants.VCPE2_ROUTER);
		logRouter.setPhysicalRouter(phyRouter);
	...
	private ConfigureBGPRequestParameters generateBGPParameters(VCPENetworkModel model) {
		...
		params.loAddr1 = ((Interface) VCPENetworkModelHelper.getElementByTemplateName(model, SPV6TemplateConstants.LO1_INTERFACE))
				.getIpAddress();
		params.upRemoteAddr1 = ((Interface) VCPENetworkModelHelper.getElementByTemplateName(model, SPV6TemplateConstants.UP1_INTERFACE_PEER))
				.getIpAddress();
		params.interAddr1 = ((Interface) VCPENetworkModelHelper.getElementByTemplateName(model, SPV6TemplateConstants.INTER1_INTERFACE_LOCAL))
				.getIpAddress();

		params.loAddr2 = ((Interface) VCPENetworkModelHelper.getElementByTemplateName(model, SPV6TemplateConstants.LO2_INTERFACE))
				.getIpAddress();
		params.upRemoteAddr2 = ((Interface) VCPENetworkModelHelper.getElementByTemplateName(model, SPV6TemplateConstants.UP2_INTERFACE_PEER))
				.getIpAddress();
		params.interAddr2 = ((Interface) VCPENetworkModelHelper.getElementByTemplateName(model, SPV6TemplateConstants.INTER2_INTERFACE_LOCAL))
				.getIpAddress();
