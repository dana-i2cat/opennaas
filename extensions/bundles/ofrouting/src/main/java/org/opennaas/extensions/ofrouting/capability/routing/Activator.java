...
public class Activator extends AbstractActivator implements BundleActivator {
	 ...
	 * @throws ActivatorException
	 */
	public static IActionSet getRoutingActionSetService(String name, String version) throws ActivatorException {

		try {
			log.debug("Calling RoutingActionSetService");
			return (IActionSet) getServiceFromRegistry(context, createFilterRoutingActionSet(name, version));
		} catch (InvalidSyntaxException e) {
			throw new ActivatorException(e);
		}
	}
	 ...
	 * @throws InvalidSyntaxException
	 */
	private static Filter createFilterRoutingActionSet(String name, String version) throws InvalidSyntaxException {

		Properties properties = new Properties();
		properties.setProperty(ResourceDescriptorConstants.ACTION_CAPABILITY, "routing");
