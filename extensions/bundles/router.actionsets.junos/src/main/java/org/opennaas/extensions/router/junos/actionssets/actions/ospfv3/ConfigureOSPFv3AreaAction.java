 ...
 * @author Jordi Puig
 */
public class ConfigureOSPFv3AreaAction extends JunosAction {

	private static final String	VELOCITY_TEMPLATE	= "/VM_files/ospfv3ConfigureArea.vm";
	 ...
	 * 
	 */
	public ConfigureOSPFv3AreaAction() {
		setActionID(ActionConstants.OSPFv3_CONFIGURE_AREA);
