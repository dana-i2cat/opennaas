...
public class UnconfigureVRRPAction extends JunosAction {
	Log							log						= LogFactory.getLog(UnconfigureVRRPAction.class);

	private static final String	VELOCITY_TEMPLATE_IPv4	= "/VM_files/unconfigureVRRP.vm";
	private static final String	VELOCITY_TEMPLATE_IPv6	= "/VM_files/unconfigureVRRPIPv6.vm";

	public UnconfigureVRRPAction() {
		super();
		initialize();
	}
	...
	protected void initialize() {
		this.setActionID(ActionConstants.VRRP_UNCONFIGURE);
	...
	public void executeListCommand(ActionResponse actionResponse, IProtocolSession protocol) throws ActionException {
		try {
			// defaultOperation = none_operation to avoid creating hierarchy when deleting
