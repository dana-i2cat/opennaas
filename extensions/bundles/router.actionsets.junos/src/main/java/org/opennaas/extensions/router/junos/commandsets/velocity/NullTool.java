...
/**
 * Tool for working with <code>null</code> in Velocity templates. It provides a method to set a VTL reference back to <code>null</code>. Also provides
 * methods to check if a VTL reference is <code>null</code> or not.
 * <p>
 * NOTE: These examples assume you have placed an instance of the current context within itself as 'ctx'. And, of course, the NullTool is assumed to
 * be available as 'null'.
 * </p>
 * <p>
 * 
 * <pre>
...
public class NullTool
{
	...
	/**
	 * A convinient method which returns <code>null</code>. Actually, this tool will work the same without this method, because Velocity treats
