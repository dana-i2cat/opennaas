 ...
 * @author Jordi Puig
 */
public class RemoveOSPFv3InterfaceInAreaAction extends JunosAction {

	private static final String	VELOCITY_TEMPLATE	= "/VM_files/ospfv3RemoveInterfaceInArea.vm";
	 ...
	 * 
	 */
	public RemoveOSPFv3InterfaceInAreaAction() {
		setActionID(ActionConstants.OSPFv3_REMOVE_INTERFACE_IN_AREA);
