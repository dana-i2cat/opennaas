 ...
 * @author Jordi Puig
 */
public class RemoveOSPFv3AreaAction extends JunosAction {

	private static final String	VELOCITY_TEMPLATE	= "/VM_files/ospfv3RemoveArea.vm";
	 ...
	 * 
	 */
	public RemoveOSPFv3AreaAction() {
		setActionID(ActionConstants.OSPFv3_REMOVE_AREA);
