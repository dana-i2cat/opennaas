 ...
 * @author Jordi Puig
 */
public class AddOSPFv3InterfaceInAreaAction extends JunosAction {

	private static final String	VELOCITY_TEMPLATE	= "/VM_files/ospfv3AddInterfaceInArea.vm";
	 ...
	 * 
	 */
	public AddOSPFv3InterfaceInAreaAction() {
		setActionID(ActionConstants.OSPFv3_ADD_INTERFACE_IN_AREA);
