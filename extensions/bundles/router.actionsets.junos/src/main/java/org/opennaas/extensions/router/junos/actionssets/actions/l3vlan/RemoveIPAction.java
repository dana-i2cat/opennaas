...
/**
 * Remove IP from L3 VLAN action
 * 
 * @author Julio Carlos Barrera
 * 
 */
public class RemoveIPAction extends JunosAction {

	Log	log	= LogFactory.getLog(RemoveIPAction.class);

	public RemoveIPAction() {
		super();
		initialize();
	}

	protected void initialize() {
		this.setActionID(ActionConstants.L3VLAN_REMOVE_IP_FROM_DOMAIN);
		setTemplate("/VM_files/l3vlan/l3vlanRemoveIP.vm");
