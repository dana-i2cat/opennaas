 ...
 */
public class ConfigureOSPFv3StatusAction extends JunosAction {

	public ConfigureOSPFv3StatusAction() {
		super();
		initialize();
	}
	...
	protected void initialize() {
		this.setActionID(ActionConstants.OSPFv3_ACTIVATE + "/" + ActionConstants.OSPFv3_DEACTIVATE);
		setTemplate("/VM_files/ospfv3ConfigureStatus.vm");
	...
	public boolean checkParams(Object params) throws ActionException {
		...
		if (!((OSPFService) params).getAlgorithmType().equals(AlgorithmType.OSPFV3))
			return false;
