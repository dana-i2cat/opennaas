...
public class AddIPv4ActionTest {

	Log								log	= LogFactory.getLog(AddIPv4ActionTest.class);
	private static AddIPv4Action	action;
	...
	public void TestActionID() {
		Assert.assertEquals("Wrong ActionID", ActionConstants.ADDIPv4, action.getActionID());
	}
	...
	public void templateTest() {
		...
		Assert.assertEquals("Invalid template", "/VM_files/addIPv4.vm", action.getTemplate());
	}
	...
	public void velocityTemplateTest() {
		try {
			...
			String expectedMessage = XmlHelper.formatXML(textFileToString("/actions/ip/addIPv4.xml"));
