...
public class RemoveOSPFInterfaceInAreaActionTest {
	Log												log	= LogFactory.getLog(RemoveOSPFInterfaceInAreaActionTest.class);
	private static RemoveOSPFInterfaceInAreaAction	action;
	...
	public static void init() {
		...
		action = new RemoveOSPFInterfaceInAreaAction();
	...
	public void actionIDTest() {
		...
		Assert.assertEquals("Wrong ActionID", ActionConstants.OSPF_REMOVE_INTERFACE_IN_AREA,
				action.getActionID());
	}
	...
	public void templateTest() {
		...
		Assert.assertEquals("Not accepted param", "/VM_files/ospfRemoveInterfaceInArea.vm", action.getTemplate());
	}
	...
	public void executeActionTest() throws IOException {
		...
		try {
			...
			Assert.assertTrue(response.getActionID()
					.equals(ActionConstants.OSPF_REMOVE_INTERFACE_IN_AREA));
