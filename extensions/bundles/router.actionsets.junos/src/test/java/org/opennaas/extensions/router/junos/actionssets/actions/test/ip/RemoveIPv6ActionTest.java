...
public class RemoveIPv6ActionTest {

	Log								log	= LogFactory.getLog(RemoveIPv6ActionTest.class);
	private static RemoveIPv6Action	action;
	...
	public void TestActionID() {
		Assert.assertEquals("Wrong ActionID", ActionConstants.REMOVEIPv6, action.getActionID());
	}
	...
	public void templateTest() {
		...
		Assert.assertEquals("Invalid template", "/VM_files/removeIPv6.vm", action.getTemplate());
	}
	...
	public void velocityTemplateTest() {
		try {
			...
			String expectedMessage = XmlHelper.formatXML(textFileToString("/actions/ip/removeIPv6.xml"));
