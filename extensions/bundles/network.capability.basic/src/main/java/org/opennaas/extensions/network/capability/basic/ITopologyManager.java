...
public interface ITopologyManager {
	 ...
	 *
	 * @param resourceToAdd IResource to be added
	 * @return NetworkModel updated with added resource
	 * @throws CapabilityException if an error occurred.
	 */
	 ...
	 *
	 * @param resourceToRemove resource to be removed
	 ...
	 *
	 * This method does not interact with real interfaces, connection is only created in topology,
	 * despite having real connectivity or not.
	 *
	 * @param interface1
	 * @param interface2
	 ...
	 *
	 * This method does not interact with real interfaces, connection is only removed from topology,
	 * despite having real connectivity or not.
	 *
	 * @param interface1
	 * @param interface2
