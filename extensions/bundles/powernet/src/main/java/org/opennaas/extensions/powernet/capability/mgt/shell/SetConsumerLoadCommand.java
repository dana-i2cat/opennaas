...
@Command(scope = "gim", name = "setConsumerLoad", description = "Set load given power consumer is designated to work with")
public class SetConsumerLoadCommand extends GenericKarafCommand {
	...
	protected Object doExecute() throws Exception {
		...
		try {
			...
			capab.setPowerConsumerRatedLoad(consumerId, voltage, current, power, energy);
		} catch (Exception e) {
