 ...
 * 
 */
public class PowerNetResourceRepository extends ResourceRepository {

	/**
	 * Logger
	 */
	Log	log	= LogFactory.getLog(PowerNetResourceRepository.class);

	/**
	 * @param resourceType
	 */
	public PowerNetResourceRepository(String resourceType) {
		super(resourceType);
	}
