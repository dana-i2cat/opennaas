...
public class CLIStreamReader {
	...
	/**
	 * Creates a CLIStreamReader that will listen for the characters received in the stream, assemble response messages and parse them
	 * 
	 * @param stream
	 * @param oStream
	 * @param prompts
	...
	/**
	 * Gets a response message from the input stream. If the request message is echoed, it will eliminate it from the response
	 * 
	 * @param request
	 * @return
	 */
