package net.i2cat.mantychore.core.resources.tests;
...
import net.i2cat.mantychore.core.resources.IResourceIdentifier;
import net.i2cat.mantychore.core.resources.IResourceRepository;
import net.i2cat.mantychore.core.resources.Resource;
import net.i2cat.mantychore.core.resources.ResourceException;
import net.i2cat.mantychore.core.resources.ResourceIdentifier;
