package net.i2cat.mantychore.core.resources.shell;
...
import net.i2cat.mantychore.core.resources.IResourceManager;
import net.i2cat.mantychore.core.resources.RegistryUtil;
 ...
 * 
 */
@Command(scope = "iaas", name = "export", description = "Export the descriptor of a resource to a file")
