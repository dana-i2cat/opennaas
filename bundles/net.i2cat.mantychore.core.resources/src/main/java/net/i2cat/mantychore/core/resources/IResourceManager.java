...
/**
 * This interface must be implemented by all the classes that want to manage resources. They must listen to all the
 * IResourceRepositories, and react to their events creating, modifying and removing resources
 * @author Eduard Grasa
 *
 */
public interface IResourceManager {
	 ...
	 * @param resourceIdentifier the id of the resource to get
	 * @return the resource
	 * @throws ResourceException
	 */
