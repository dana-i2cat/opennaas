...
import net.i2cat.mantychore.core.resourcemanager.soapendpoint.IResourceManagerSOAPEndpoint;
import net.i2cat.mantychore.core.resourcemanager.soapendpoint.ResourceData;
import net.i2cat.mantychore.core.resourcemanager.soapendpoint.ResourceManagerSOAPEndpoint;
import net.i2cat.mantychore.core.resources.ResourceException;
import net.i2cat.mantychore.core.resources.ResourceManager;
import net.i2cat.mantychore.core.resources.ResourceRepository;
import net.i2cat.mantychore.core.resources.capability.ICapabilityFactory;
