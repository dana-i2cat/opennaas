...
public class SwitchPortPair extends SAPSAPDependency implements Serializable 
    ...
    /**
     * This method create an Association of the type SwitchPortPair between 
     * one SwitchPort object and SwitchPort object 
     */
    public Association link(SwitchPort antecedent,SwitchPort dependent){

    return super.link(SwitchPortPair.class,antecedent,dependent);
    }//link
    /**
