...
public class IsSpare extends Dependency implements Serializable {
    ...
    public IsSpare(){};
    /**
     * This method create an Association of the type IsSpare between one 
     * ManagedElement object and RedundancySet object 
     */
    public Association link(ManagedElement antecedent,RedundancySet 
	dependent){

    return super.link(IsSpare.class,antecedent,dependent);
    }//link
    /**
