...
public class IPProtocolEndpoint extends ProtocolEndpoint implements
	...
	public List<NextHopIPRoute> getRouteUsesEndpoint() {
		return (List<NextHopIPRoute>) this.getFromAssociatedElementsByType(RouteUsesEndpoint.class);
	}
	...
	/**
	 * This method returns the IPProtocolEndpoint.iPv6AddressType property
	 * value. This property is described as follows:
	 * 
	 * IPv6AddressType indentified the type of address found in the IPv6Address
	 * property. The values of this property shall be interpreted according to
	 * RFC4291, Section 2.4
	 * 
	...
	/**
	 * This method sets the IPProtocolEndpoint.iPv6AddressType property value.
	 * This property is described as follows:
	 * 
	 * IPv6AddressType indentified the type of address found in the IPv6Address
	 * property. The values of this property shall be interpreted according to
	...
	/**
	 * This method returns the IPProtocolEndpoint.iPv6SubnetPrefixLength
	...
	/**
	 * This method sets the IPProtocolEndpoint.iPv6SubnetPrefixLength property
	 * value. This property is described as follows:
	 * 
	 * IPv6SubnetPrefixLength is used to identify the prefix length of the
	 * IPv6Address property that is used to specify a subnet
