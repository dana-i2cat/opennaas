...
public class AssociatedPowerManagementService extends
	...
	/**
	 * The following constants are defined for use with the ValueMap/Values qualified property ServiceProvided.
	 */
	private PowerManagementService	serviceProvided;

	/**
	 * This method returns the AssociatedPowerManagementService.ServiceProvided property value. This property is described as follows:
	 * 
	 * The Service that is available.
	 * 
	 * @return CIM_PowerManagementService current ServiceProvided property value
	 * @exception Exception
	 */
	...
	/**
	 * This method sets the AssociatedPowerManagementService.ServiceProvided property value. This property is described as follows:
	 * 
	 * The Service that is available.
	 * 
	 * @param CIM_PowerManagementService
	 *            new ServiceProvided property value
	 * @exception Exception
	 */
	...
	/**
	 * The following constants are defined for use with the ValueMap/Values qualified property PowerState.
	 */
	...
	/**
	 * This method returns the AssociatedPowerManagementService.PowerState property value. This property is described as follows:
	 * 
	...
	/**
	 * This method sets the AssociatedPowerManagementService.PowerState property value. This property is described as follows:
	 * 
	 * The current power state of the associated Managed System Element.
	 * 
	...
	RequestedPowerState	requestedPowerState;
	...
	AvailableRequestedPowerStates	availableRequestedPowerStates;
	 ...
	 * 
	 * @return short current AvailableRequestedPowerStates property value
	 * @exception Exception
	 */
	 ...
	 * preceded by a request to the managed element to perform an orderly shutdown. ..=DMTF Reserved. 0x7FFF..0xFFFF = Vendor Specific.
	 * 
	 * @param short new AvailableRequestedPowerStates property value
	 * @exception Exception
	 */
	...
	TransitioningToPowerState	transitioningToPowerState;
	 ...
	 * 
	 * @return short current TransitioningToPowerState property value
	 * @exception Exception
	 */
