...
public class AssociatedPowerManagementService extends 
     ...
     * "Power Cycle (Off - Soft)" or 6, "Power Cycle (Off - Hard)". 
     * 
     * @param	Date	new powerOnTime property value
     * @exception	Exception	
     */
     ...
     * 
     * @return	int	current availableRequestedPowerStates 
     * property value 
     * @exception	Exception	
     */
     ...
     * orderly shutdown. ..=DMTF Reserved. 0x7FFF..0xFFFF = Vendor Specific. 
     * 
     * @param	int	new availableRequestedPowerStates property 
     * value 
     * @exception	Exception	
     */
     ...
     * 
     * @return	int	current transitioningToPowerState property 
     * value 
     * @exception	Exception	
     */
