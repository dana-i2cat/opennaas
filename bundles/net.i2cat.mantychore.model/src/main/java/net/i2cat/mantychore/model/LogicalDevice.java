...
public class LogicalDevice extends EnabledLogicalElement implements 
     ...
     * LogicalDevice in a Java Bean. The CIM class LogicalDevice is described 
     * as follows: 
     * 
    ...
    /**
     * This method sets the LogicalDevice.creationClassName property value. 
     * This property is described as follows: 
     * 
     * CreationClassName indicates the name of the class or the subclass used 
     * in the creation of an instance. When used with the other key 
    ...
    /**
     * This method sets the LogicalDevice.deviceID property value. This 
     * property is described as follows: 
     * 
     * An address or other identifying information to uniquely name the 
     * LogicalDevice. 
     ...
     */
    @Deprecated    private boolean powerManagementSupported;
    /**
     * This method returns the LogicalDevice.powerManagementSupported property 
     * value. This property is described as follows: 
     * 
     * Boolean indicating that the Device can be power managed. The use of 
     * this property has been deprecated. Instead, the existence of an 
     * associated PowerManagementCapabilities class (associated using the 
     * ElementCapabilities relationhip) indicates that power management is 
     * supported. 
     * 
     * @return	boolean	current powerManagementSupported property 
     * value 
     * @exception	Exception	
     */
    @Deprecated
     ...
     * supported. 
     * 
     * @param	boolean	new powerManagementSupported property 
     * value 
     * @exception	Exception	
     */
    @Deprecated
     ...
     * 
     * @return	int	current powerManagementCapabilities property 
     * value 
     * @exception	Exception	
     */
    @Deprecated
     ...
     * Device is running and has full power (value=3), or is in a warning 
     * (4), test (5), degraded (10) or power save state (values 13-15 and 
     * 17). Regarding the Power Save states, these are defined as follows: 
     * Value 13 ("Power Save - Unknown") indicates that the Device is known 
     * to be in a power save mode, but its exact status in this mode is 
     * unknown; 14 ("Power Save - Low Power Mode") indicates that the Device 
     * is in a power save state but still functioning, and may exhibit 
     * degraded performance; 15 ("Power Save - Standby") describes that the 
     * Device is not functioning but could be brought to full power 
     * 'quickly'; and value 17 ("Power Save - Warning") indicates that the 
     ...
     * powered up, and is configured and operational. The Device may or may 
     * not be functionally active, depending on whether its Availability (or 
     * AdditionalAvailability) indicate that it is 
     * ("Running/Full Power")(value=3) or ("Off line") (value=8). In an 
     * enabled but offline mode, a Device may be performing out-of-band 
     * requests, such as running Diagnostics. If ("Disabled") StatusInfo 
     * value=4), a Device can only be "enabled" or powered off. In a personal 
     * computer environment, ("Disabled") means that the Device's driver is 
     * not available in the stack. In other environments, a Device can be 
     * disabled by removing its configuration file. A disabled device is 
     * physically present in a System and consuming resources, but can not be 
     * communicated with until a load of a driver, a load of a configuration 
     * file or some other "enabling" activity has occurred. 
     * 
     ...
     */
    @Deprecated    private long lastErrorCode;
    /**
     * This method returns the LogicalDevice.lastErrorCode property value. 
     * This property is described as follows: 
     * 
     ...
     */
    @Deprecated    private String errorDescription;
    /**
    ...
    /**
     * This method sets the LogicalDevice.errorDescription property value. 
     * This property is described as follows: 
     * 
     * ErrorDescription is a free-form string supplying more information about 
     * the error recorded in LastErrorCode, and information on any corrective 
     ...
     */
    @Deprecated    private boolean errorCleared;
    /**
     ...
     * example would be to hold the Operating System's user friendly name for 
    ...
    /**
     * This method sets the LogicalDevice.totalPowerOnHours property value. 
     * This property is described as follows: 
     * 
     * The total number of hours that this Device has been powered.
     * 
     ...
     * the entries in the OtherIdentifyingInfo array. Note, each entry of 
     ...
     * primary status and availability of the Device. In some cases, this 
     * will not be sufficient to denote the complete status of the Device. In 
     * those cases, the AdditionalAvailability property can be used to 
     * provide further information. For example, a Device's primary 
     * Availability may be "Off line" (value=8), but it may also be in a low 
     * power state (AdditonalAvailability value=14), or the Device could be 
     * running Diagnostics (AdditionalAvailability value=5, "In Test"). 
     * 
    ...
    /**
     * This method sets the LogicalDevice.additionalAvailability property 
     * value. This property is described as follows: 
     * 
     * Additional availability and status of the Device, beyond that specified 
     * in the Availability property. The Availability property denotes the 
     ...
     */
    @Deprecated    private long maxQuiesceTime;
    /**
     * This method returns the LogicalDevice.maxQuiesceTime property value. 
     * This property is described as follows: 
     * 
     * The MaxQuiesceTime property has been deprecated. When evaluating the 
     * use of Quiesce, it was determine that this single property is not 
     * adequate for describing when a device will automatically exit a 
     * quiescent state. In fact, the most likely scenario for a device to 
     * exit a quiescent state was determined to be based on the number of 
     * outstanding requests queued rather than on a maximum time. This will 
     * be re-evaluated and repositioned later. Maximum time in milliseconds, 
     * that a Device can run in a "Quiesced" state. A Device's state is 
     * defined in its Availability and AdditionalAvailability properties, 
     * where "Quiesced" is conveyed by the value 21. What occurs at the end 
     * of the time limit is device-specific. The Device may unquiesce, may 
     * offline or take other action. A value of 0 indicates that a Device can 
