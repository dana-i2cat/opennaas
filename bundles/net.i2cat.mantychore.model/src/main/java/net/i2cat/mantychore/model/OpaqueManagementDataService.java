...
public class OpaqueManagementDataService extends Service implements 
     ...
     */
    private CIMDateTime lockTimeout;
    /**
     ...
     * 
     * @return	CIMDateTime	current LockTimeout property value
     * @exception	Exception	
     */
    public CIMDateTime getLockTimeout(){
     ...
     * LockTimeout shall be a duration. 
     * 
     * @param	CIMDateTime	new LockTimeout property value
     * @exception	Exception	
     */
    public void setLockTimeout(CIMDateTime lockTimeout) {
