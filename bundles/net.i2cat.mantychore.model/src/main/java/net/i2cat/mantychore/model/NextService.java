...
public class NextService extends Association implements Serializable {
    ...
    public NextService(){};
    /**
     * This method create an Association of the type NextService between one 
     * ConditioningService object and ConditioningService object 
     */
    public Association link(ConditioningService 
	precedingService,ConditioningService followingService){

    return super.link(NextService.class,precedingService,followingService);
    }//link
