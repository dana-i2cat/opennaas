...
public class ServiceAvailableToElement extends Association implements 
    ...
    /**
     * This method create an Association of the type ServiceAvailableToElement 
     * between one Service object and ManagedElement object 
     */
    public Association link(Service serviceProvided,ManagedElement 
	userOfService){

    return 
	super.link(ServiceAvailableToElement.class,serviceProvided,userOfService);
    }//link
