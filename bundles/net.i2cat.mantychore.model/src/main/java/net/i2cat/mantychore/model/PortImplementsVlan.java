 ...
 */
    @Entity
public class PortImplementsVlan extends DeviceSAPImplementation implements 
    Serializable {
    ...
    return super.link(PortImplementsVlan.class,antecedent,dependent);
    }//link
