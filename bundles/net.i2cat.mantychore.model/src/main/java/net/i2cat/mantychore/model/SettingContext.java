...
public class SettingContext extends Association implements Serializable {
    ...
    /**
     * This method create an Association of the type SettingContext between 
     * one Configuration object and Setting object 
     */
    @Deprecated
    public Association link(Configuration context,Setting setting){

    return super.link(SettingContext.class,context,setting);
    }//link
