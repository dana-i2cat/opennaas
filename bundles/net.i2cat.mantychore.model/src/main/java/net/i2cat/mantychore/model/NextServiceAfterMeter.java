...
public class NextServiceAfterMeter extends Association implements Serializable 
    ...
    /**
     * This method create an Association of the type NextServiceAfterMeter 
     * between one MeterService object and ConditioningService object 
     */
    public Association link(MeterService precedingService,ConditioningService 
	followingService){

    return 
	super.link(NextServiceAfterMeter.class,precedingService,followingService);
    }//link
    /**
