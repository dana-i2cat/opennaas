...
public class ElementCapabilities extends Association implements Serializable 
    ...
    /**
     * This method create an Association of the type ElementCapabilities 
     * between one ManagedElement object and Capabilities object 
     */
    public Association link(ManagedElement managedElement,Capabilities 
	capabilities){

    return super.link(ElementCapabilities.class,managedElement,capabilities);
    }//link
    /**
