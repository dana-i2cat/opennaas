...
public class IngressConditioningServiceOnEndpoint extends ServiceSAPDependency 
     ...
     */
    public Association link(ProtocolEndpoint antecedent,ConditioningService 
	dependent){

    return super.link(IngressConditioningServiceOnEndpoint.class,antecedent,dependent);
    }//link
