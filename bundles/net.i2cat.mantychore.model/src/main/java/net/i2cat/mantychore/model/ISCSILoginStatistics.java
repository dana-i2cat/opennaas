...
public class ISCSILoginStatistics extends StatisticalData implements
	 ...
	 * 
	 * @return CIMDateTime current LastLoginFailureTime property value
	 * @exception Exception
	 */
	 ...
	 * 
	 * @return short current LastLoginFailureRemoteAddressType property value
	 * @exception Exception
	 */
	public LastLoginFailureRemoteAddressType getLastLoginFailureRemoteAddressType() {
	 ...
	 * The type of Internet Network Address of the remote node that failed the last login attempt.
	 * 
	 * @param short new LastLoginFailureRemoteAddressType property value
	 * @exception Exception
	 */
	public void setLastLoginFailureRemoteAddressType(LastLoginFailureRemoteAddressType
	 ...
	 * 
	 * @return int current LastLoginFailureRemoteAddress property value
	 * @exception Exception
	 */
	 ...
	 * An Internet Network Address giving the host address of the remote node that failed the last login attempt.
	 * 
	 * @param int new LastLoginFailureRemoteAddress property value
	 * @exception Exception
	 */
