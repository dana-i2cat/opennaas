...
public class DHCPProtocolEndpoint extends ProtocolEndpoint implements 
     ...
     * 
     * @return	short	current ClientState property value
     * @exception	Exception	
     */
     ...
     * RFC1541 for more information on the meaning of each state. 
     * 
     * @param	short	new ClientState property value
     * @exception	Exception	
     */
     ...
     * 
     * @return	int	current RenewalTime property value
     * @exception	Exception	
     */
     ...
     * to the value for code 58 as defined in RFC2132. 
     * 
     * @param	int	new RenewalTime property value
     * @exception	Exception	
     */
     ...
     * 
     * @return	int	current RebindingTime property value
     * @exception	Exception	
     */
     ...
     * to the value for code 59 as defined in RFC2132. 
     * 
     * @param	int	new RebindingTime property value
     * @exception	Exception	
     */
     ...
     * Section 9 
     * 
     * @return	int	current LeaseTime property value
     * @exception	Exception	
     */
     ...
     * Section 9 
     * 
     * @param	int	new LeaseTime property value
     * @exception	Exception	
     */
     ...
     */
    private CIMDateTime leaseObtained;
    /**
     ...
     * server. 
     * 
     * @return	CIMDateTime	current LeaseObtained property value
     * @exception	Exception	
     */
    public CIMDateTime getLeaseObtained(){
     ...
     * server. 
     * 
     * @param	CIMDateTime	new LeaseObtained property value
     * @exception	Exception	
     */
    public void setLeaseObtained(CIMDateTime leaseObtained) {
     ...
     */
    private CIMDateTime leaseExpires;
    /**
     ...
     * LeaseObtained. 
     * 
     * @return	CIMDateTime	current LeaseExpires property value
     * @exception	Exception	
     */
    public CIMDateTime getLeaseExpires(){
     ...
     * LeaseObtained. 
     * 
     * @param	CIMDateTime	new LeaseExpires property value
     * @exception	Exception	
     */
    public void setLeaseExpires(CIMDateTime leaseExpires) {
     ...
     * 
     * @return	short	current OptionsReceived property value
     * @exception	Exception	
     */
     ...
     * for a description of each option. 
     * 
     * @param	short	new OptionsReceived property value
     * @exception	Exception	
     */
