...
public class AFService extends DiffServService implements Serializable {
     ...
     * ClassNumber. 
     * 
     * @return	Byte	current ClassNumber property value
     * @exception	Exception	
     */
     ...
     * ClassNumber. 
     * 
     * @param	Byte	new ClassNumber property value
     * @exception	Exception	
     */
     ...
     * 
     * @return	Byte	current DropperNumber property value
     * @exception	Exception	
     */
    public Byte getDropperNumber(){
     ...
     * aggregated by QoSConditioningSubService. 
     * 
     * @param	Byte	new DropperNumber property value
     * @exception	Exception	
     */
    public void setDropperNumber(Byte dropperNumber) {
