...
public class InboundVLAN extends SAPSAPDependency implements Serializable {
    ...
    public InboundVLAN(){};
    /**
     * This method create an Association of the type InboundVLAN between one 
     * VLAN object and SwitchPort object 
     */
    @Deprecated
    public Association link(VLAN antecedent,SwitchPort dependent){

    return super.link(InboundVLAN.class,antecedent,dependent);
    }//link
    /**
    ...
    /**
     * The following constants are defined for use with the ValueMap/Values 
     * qualified property _default. 
     */
    @Deprecated    private boolean _default;
    /**
     * This method returns the InboundVLAN._default property value. This 
     * property is described as follows: 
     * 
    ...
    /**
     * This method sets the InboundVLAN._default property value. This property 
     * is described as follows: 
     * 
     * Default should be TRUE if untagged packets received by the SwitchPort 
     * are assigned to the VLAN. For 802.1Q-compliant ports, the Default 
