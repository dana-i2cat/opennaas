...
public class ClassifierFilterSet extends Dependency implements Serializable 
    ...
    /**
     * This method create an Association of the type ClassifierFilterSet 
     * between one FilterList object and ClassifierService object 
     */
    @Deprecated
    public Association link(FilterList antecedent,ClassifierService 
	dependent){

    return super.link(ClassifierFilterSet.class,antecedent,dependent);
    }//link
    /**
     * The following constants are defined for use with the ValueMap/Values 
     * qualified property filterListPosition. 
     */
    @Deprecated    private int filterListPosition;
    /**
