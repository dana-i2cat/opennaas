...
public class StatisticalData extends ManagedElement implements Serializable 
     ...
     */
    private CIMDateTime statisticTime;
    /**
     ...
     * 
     * @return	CIMDateTime	current StatisticTime property value
     * @exception	Exception	
     */
    public CIMDateTime getStatisticTime(){
     ...
     * element where the statistic was collected. 
     * 
     * @param	CIMDateTime	new StatisticTime property value
     * @exception	Exception	
     */
    public void setStatisticTime(CIMDateTime statisticTime) {
