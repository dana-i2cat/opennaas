 ...
 * in the CIM class ProtocolEndpoint as well as methods comparable to the
 * invokeMethods defined for this class. This Class implements the
 * ProtocolEndpointBean Interface. The CIM class ProtocolEndpoint is described
 * as follows:
 * 
 * A communication point from which data can be sent or received.
 * ProtocolEndpoints link system or computer interfaces to LogicalNetworks.
 */
@Entity
public class ProtocolEndpoint extends ServiceAccessPoint implements
	...
	public List<NextHopRoute> getRouteUsesEndpoints() {
		return (List<NextHopRoute>) this.getFromAssociatedElementsByType(RouteUsesEndpoint.class);
	}
	 ...
	 * implements the ProtocolEndpointBean Interface, and encapsulates the CIM
	 * class ProtocolEndpoint in a Java Bean. The CIM class ProtocolEndpoint is
	...
	/**
	 * This method returns the ProtocolEndpoint.description property value. This
	...
	/**
	 * This method sets the ProtocolEndpoint.description property value. This
	 * property is described as follows:
	 * 
	 * The Description property provides a textual description of the object.
	 * 
	...
	/**
	 * This method returns the ProtocolEndpoint.timeOfLastStateChange property
	 * value. This property is described as follows:
	 * 
	 * The date or time when the EnabledState of the element last changed. If
	 * the state of the element has not changed and this property is populated,
	 * then it must be set to a 0 interval value. If a state change was
	...
	/**
	 * This method sets the ProtocolEndpoint.timeOfLastStateChange property
	 * value. This property is described as follows:
	 * 
	 * The date or time when the EnabledState of the element last changed. If
	 * the state of the element has not changed and this property is populated,
	...
	/**
	 * This method returns the ProtocolEndpoint.name property value. This
	 * property is described as follows:
	 * 
	 * A string that identifies this ProtocolEndpoint with either a port or an
	 * interface on a device. To ensure uniqueness, the Name property should be
	 * prepended or appended with information from the Type or
	 * OtherTypeDescription properties. The method selected is described in the
	...
	/**
	 * This method sets the ProtocolEndpoint.name property value. This property
	...
	/**
	 * This method returns the ProtocolEndpoint.nameFormat property value. This
	 * property is described as follows:
	 * 
	 * NameFormat contains the naming heuristic that is selected to ensure that
	 * the value of the Name property is unique. For example, you might choose
	 * to prepend the name of the port or interface with the Type of
	 * ProtocolEndpoint (for example, IPv4) of this instance followed by an
	 * underscore.
	 * 
	...
	/**
	 * This method sets the ProtocolEndpoint.nameFormat property value. This
	 * property is described as follows:
	 * 
	 * NameFormat contains the naming heuristic that is selected to ensure that
	 * the value of the Name property is unique. For example, you might choose
	...
	/**
	 * This method returns the ProtocolEndpoint.protocolType property value.
	 * This property is described as follows:
	 * 
	 * Note: This property is deprecated in lieu of the ProtocolIFType
	 ...
	 * overlap. However, there are several cases where a specific subclass of
	 * ProtocolEndpoint is not required (for example, there is no Fibre Channel
	 * subclass of ProtocolEndpoint). Therefore, this property is needed to
	...
	/**
	 * This method sets the ProtocolEndpoint.protocolType property value. This
	 * property is described as follows:
	 * 
	 * Note: This property is deprecated in lieu of the ProtocolIFType
	 * enumeration. This deprecation was done to have better alignment between
	 ...
	 * http://www.iana.org/assignments/ianaiftype-mib. Also, additional values
	 * defined by the DMTF are included. The property is used to categorize and
	 * classify instances of the ProtocolEndpoint class. Note that if the
	 * ProtocolIFType is set to 1 (Other), then the type information should be
	...
	/**
	 * This method sets the ProtocolEndpoint.protocolIFType property value. This
	 * property is described as follows:
	 * 
	 * ProtocolIFType is an enumeration that is synchronized with the IANA
	 * ifType MIB. The ifType MIB is maintained at the URL,
	...
	/**
	 * This method returns the ProtocolEndpoint.otherTypeDescription property
	 * value. This property is described as follows:
	 * 
	 ...
	 * This property should be set to null when the Type property is any value
	 * other than 1.
	 * 
	...
	/**
	 * This method sets the ProtocolEndpoint.otherTypeDescription property
	 * value. This property is described as follows:
	 * 
	 * A string that describes the type of ProtocolEndpoint when the Type
	 * property of this class (or any of its subclasses) is set to 1 (Other).
