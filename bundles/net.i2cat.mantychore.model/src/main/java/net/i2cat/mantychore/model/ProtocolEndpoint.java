 ...
 * ProtocolEndpointBean Interface. The CIM class ProtocolEndpoint is 
...
public class ProtocolEndpoint extends ServiceAccessPoint implements 
     ...
     * implements the ProtocolEndpointBean Interface, and encapsulates the 
     * CIM class ProtocolEndpoint in a Java Bean. The CIM class 
     * ProtocolEndpoint is described as follows: 
     * 
     * A communication point from which data can be sent or received. 
    ...
    /**
     * This method returns the ProtocolEndpoint.Description property value. 
     ...
     * interface on a device. To ensure uniqueness, the Name property should 
     * be prepended or appended with information from the Type or 
     * OtherTypeDescription properties. The method selected is described in 
     * the NameFormat property of this class. 
     * 
    ...
    /**
     * This method sets the ProtocolEndpoint.Name property value. This 
     * property is described as follows: 
     * 
     * A string that identifies this ProtocolEndpoint with either a port or an 
     * interface on a device. To ensure uniqueness, the Name property should 
    ...
    /**
     * This method returns the ProtocolEndpoint.NameFormat property value. 
     * This property is described as follows: 
     * 
     * NameFormat contains the naming heuristic that is selected to ensure 
     * that the value of the Name property is unique. For example, you might 
     * choose to prepend the name of the port or interface with the Type of 
 ...
 private ProtocolType protocolType;
     ...
     * description: ProtocolType is an enumeration that provides information 
     * to categorize and classify different instances of this class. For most 
     * instances, information in this enumeration and the definition of the 
     * subclass overlap. However, there are several cases where a specific 
     * subclass of ProtocolEndpoint is not required (for example, there is no 
     * Fibre Channel subclass of ProtocolEndpoint). Therefore, this property 
 ...
 private ProtocolIFType protocolIFType;
    ...
    /**
     * This method sets the ProtocolEndpoint.ProtocolIFType property value. 
     * This property is described as follows: 
     * 
     * ProtocolIFType is an enumeration that is synchronized with the IANA 
     * ifType MIB. The ifType MIB is maintained at the URL, 
