...
public class OSPFServiceConfiguration extends Dependency implements 
    ...
    /**
     * This method create an Association of the type OSPFServiceConfiguration 
     * between one OSPFService object and OSPFAreaConfiguration object 
     */
    public Association link(OSPFService antecedent,OSPFAreaConfiguration 
	dependent){

    return super.link(OSPFServiceConfiguration.class,antecedent,dependent);
    }//link
