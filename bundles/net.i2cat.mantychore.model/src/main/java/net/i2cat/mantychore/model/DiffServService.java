...
public class DiffServService extends QoSService implements Serializable {
     ...
     * Hop Behavior. 
     * 
     * @return	Byte	current DSCP property value
     * @exception	Exception	
     */
    @Deprecated
    public Byte getDSCP(){
     ...
     * Hop Behavior. 
     * 
     * @param	Byte	new DSCP property value
     * @exception	Exception	
     */
    @Deprecated
     ...
     * 
     * @return	short	current PHBID property value
     * @exception	Exception	
     */
    public short getPHBID(){
     ...
     * coordination and operation. 
     * 
     * @param	short	new PHBID property value
     * @exception	Exception	
     */
    public void setPHBID(short pHBID) {
