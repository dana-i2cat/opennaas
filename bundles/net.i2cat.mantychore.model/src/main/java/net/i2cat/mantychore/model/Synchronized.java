...
public class Synchronized implements Serializable {
	...
	/**
	 * The following constants are defined for use with the ValueMap/Values qualified property SystemElement.
	 */
	private ManagedElement	systemElement;

	/**
	 * This method returns the Synchronized.SystemElement property value. This property is described as follows:
	 * 
	 * SystemElement represents one ManagedElement that is synchronized with the entity referenced as SyncedElement.
	 * 
	 * @return CIM_ManagedElement current SystemElement property value
	 * @exception Exception
	 */
	...
	/**
	 * This method sets the Synchronized.SystemElement property value. This property is described as follows:
	 * 
	 * SystemElement represents one ManagedElement that is synchronized with the entity referenced as SyncedElement.
	 * 
	 * @param CIM_ManagedElement
	 *            new SystemElement property value
	 * @exception Exception
	 */
	...
	/**
	 * The following constants are defined for use with the ValueMap/Values qualified property SyncedElement.
	 */
	private ManagedElement	syncedElement;

	/**
	 * This method returns the Synchronized.SyncedElement property value. This property is described as follows:
	 * 
	 * SyncedElement represents another ManagedElement that is synchronized with the entity referenced as SystemElement.
	 * 
	 * @return CIM_ManagedElement current SyncedElement property value
	 * @exception Exception
	 */
	...
	/**
	 * This method sets the Synchronized.SyncedElement property value. This property is described as follows:
	 * 
	 * SyncedElement represents another ManagedElement that is synchronized with the entity referenced as SystemElement.
	 * 
	 * @param CIM_ManagedElement
	 *            new SyncedElement property value
	 * @exception Exception
	 */
