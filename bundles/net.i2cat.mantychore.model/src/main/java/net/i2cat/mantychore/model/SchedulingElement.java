 ...
 * in the CIM class SchedulingElement as well as methods comparable to the 
 * invokeMethods defined for this class. This Class implements the 
 * SchedulingElementBean Interface. The CIM class SchedulingElement is 
 * described as follows: 
 * 
 * SchedulingElement represents the configuration information that a 
 * PacketSchedulingService has for one of the elements that it is scheduling. 
 * The scheduled element is either a QueuingService or another Packet 
 * SchedulingService. Among the subclasses of this class, some are defined in 
 * such a way that all of their instances are work conserving. Other 
 * subclasses, however, have instances that either are or are not work 
 * conserving. In this class, the boolean property WorkConserving indicates 
 * whether an instance is or is not work conserving. Note that WorkConserving 
 * is restricted to TRUE in the subclasses that are inherently work 
 * conserving, since instances of these classes cannot be anything else. 
 */
    @Entity
public class SchedulingElement extends ManagedElement implements Serializable 
    ...
    /**
     * This constructor creates a SchedulingElementBeanImpl Class which 
     * implements the SchedulingElementBean Interface, and encapsulates the 
     * CIM class SchedulingElement in a Java Bean. The CIM class 
     * SchedulingElement is described as follows: 
     * 
     * SchedulingElement represents the configuration information that a 
     * PacketSchedulingService has for one of the elements that it is 
     * scheduling. The scheduled element is either a QueuingService or 
     * another Packet SchedulingService. Among the subclasses of this class, 
     * some are defined in such a way that all of their instances are work 
     * conserving. Other subclasses, however, have instances that either are 
     * or are not work conserving. In this class, the boolean property 
     * WorkConserving indicates whether an instance is or is not work 
     * conserving. Note that WorkConserving is restricted to TRUE in the 
     * subclasses that are inherently work conserving, since instances of 
     * these classes cannot be anything else. 
     */
    ...
    /**
     * This method returns the SchedulingElement.instanceID property value. 
    ...
    /**
     * This method sets the SchedulingElement.instanceID property value. This 
    ...
    /**
     * This method returns the SchedulingElement.workConserving property 
    ...
    /**
     * This method sets the SchedulingElement.workConserving property value. 
     * This property is described as follows: 
     * 
     * A boolean property indicating whether the PacketSchedulingService tied 
     * to this instance (by the ElementInSchedulingService aggregation) is 
