 ...
 * in the CIM class SystemSpecificCollection as well as methods comparable to 
 * the invokeMethods defined for this class. This Class implements the 
 * SystemSpecificCollectionBean Interface. The CIM class 
 * SystemSpecificCollection is described as follows: 
 * 
 * SystemSpecificCollection represents the general concept of a collection 
 * that is scoped (or contained) by a System. It represents a Collection that 
 * has meaning only in the context of a System, a Collection whose elements 
 * are restricted by the definition of the System, or both of these types of 
 * Collections. This meaning is explicitly described by the (required) 
 * association, HostedCollection. An example of a SystemSpecificCollection is 
 * a Fibre Channel zone that collects network ports, port groupings, and 
 * aliases (as required by a customer) in the context of an AdminDomain. The 
 * Collection is not a part of the domain, but merely an arbitrary grouping 
 * of the devices and other Collections in the domain. In other words, the 
 * context of the Collection is restricted to the domain, and its members are 
 * also limited by the domain. 
 */
public class SystemSpecificCollection extends Collection implements 
    Serializable {

    /**
     * This constructor creates a SystemSpecificCollectionBeanImpl Class which 
     * implements the SystemSpecificCollectionBean Interface, and 
     * encapsulates the CIM class SystemSpecificCollection in a Java Bean. 
     * The CIM class SystemSpecificCollection is described as follows: 
     * 
     * SystemSpecificCollection represents the general concept of a collection 
     ...
     * SystemSpecificCollection is a Fibre Channel zone that collects network 
    ...
    /**
     * This method returns the SystemSpecificCollection.InstanceID property 
     ...
     * InstanceID is not re-used as any of InstanceIDs produced by this or 
     * other providers for the NameSpace of this instance. For DMTF-defined 
    ...
    /**
     * This method sets the SystemSpecificCollection.InstanceID property 
     * value. This property is described as follows: 
     * 
     * Within the scope of the instantiating Namespace, InstanceID opaquely 
     * and uniquely identifies an instance of this class. To ensure 
