...
public class QueueHierarchy extends ServiceServiceDependency implements 
    ...
    /**
     * This method create an Association of the type QueueHierarchy between 
     * one QueuingService object and QueuingService object 
     */
    @Deprecated
    public Association link(QueuingService antecedent,QueuingService 
	dependent){

    return super.link(QueueHierarchy.class,antecedent,dependent);
    }//link
