...
response=$(curl -H "Content-Type: application/json"  -H "Accept: text/plaiST -d @vrf.json http://admin:123456@localhost:8888/opennaas/vrf/routing/insertRouteFromFile/vrf)
echo $response
echo "Insert done..."
