...
response=$(curl -H "Content-Type: application/json"  -H "Accept: text/plain" -d @vrf.json http://admin:123456@localhost:8888/opennaas/vrf/staticrouting/insertRouteFromFile/vrf)
echo $response
echo "Insert done..."
